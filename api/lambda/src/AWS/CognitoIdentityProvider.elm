module AWS.CognitoIdentityProvider exposing
    ...
    , AwsaccountIdType, AccountTakeoverActionNotifyType, AccountTakeoverActionType, AccountTakeoverActionsType, AccountTakeoverEventActionType(..), accountTakeoverEventActionType, AccountTakeoverRiskConfigurationType, AddCustomAttributesRequest, AddCustomAttributesResponse, AdminAddUserToGroupRequest, AdminConfirmSignUpRequest, AdminConfirmSignUpResponse, AdminCreateUserConfigType, AdminCreateUserRequest, AdminCreateUserResponse, adminCreateUserUnusedAccountValidityDaysType, AdminDeleteUserAttributesRequest, AdminDeleteUserAttributesResponse, AdminDeleteUserRequest, AdminDisableProviderForUserRequest, AdminDisableProviderForUserResponse, AdminDisableUserRequest, AdminDisableUserResponse, AdminEnableUserRequest, AdminEnableUserResponse, AdminForgetDeviceRequest, AdminGetDeviceRequest, AdminGetDeviceResponse, AdminGetUserRequest, AdminGetUserResponse, AdminInitiateAuthRequest, AdminInitiateAuthResponse, AdminLinkProviderForUserRequest, AdminLinkProviderForUserResponse, AdminListDevicesRequest, AdminListDevicesResponse, AdminListGroupsForUserRequest, AdminListGroupsForUserResponse, AdminListUserAuthEventsRequest, AdminListUserAuthEventsResponse, AdminRemoveUserFromGroupRequest, AdminResetUserPasswordRequest, AdminResetUserPasswordResponse, AdminRespondToAuthChallengeRequest, AdminRespondToAuthChallengeResponse, AdminSetUserMfapreferenceRequest, AdminSetUserMfapreferenceResponse, AdminSetUserPasswordRequest, AdminSetUserPasswordResponse, AdminSetUserSettingsRequest, AdminSetUserSettingsResponse, AdminUpdateAuthEventFeedbackRequest, AdminUpdateAuthEventFeedbackResponse, AdminUpdateDeviceStatusRequest, AdminUpdateDeviceStatusResponse, AdminUpdateUserAttributesRequest, AdminUpdateUserAttributesResponse, AdminUserGlobalSignOutRequest, AdminUserGlobalSignOutResponse, AdvancedSecurityModeType(..), advancedSecurityModeType, AliasAttributeType(..), aliasAttributeType, AliasAttributesListType, AnalyticsConfigurationType, AnalyticsMetadataType, arnType, AssociateSoftwareTokenRequest, AssociateSoftwareTokenResponse, AttributeDataType(..), attributeDataType, AttributeListType, attributeMappingKeyType, AttributeMappingType, AttributeNameListType, attributeNameType, AttributeType, attributeValueType, AuthEventType, AuthEventsType, AuthFlowType(..), authFlowType, AuthParametersType, AuthenticationResultType, BlockedIprangeListType, BooleanType, Csstype, CssversionType, CallbackUrlsListType, ChallengeName(..), challengeName, ChallengeNameType(..), challengeNameType, ChallengeParametersType, ChallengeResponse(..), challengeResponse, ChallengeResponseListType, ChallengeResponseType, ChallengeResponsesType, ChangePasswordRequest, ChangePasswordResponse, clientIdType, ClientMetadataType, clientNameType, ClientPermissionListType, clientPermissionType, clientSecretType, CodeDeliveryDetailsListType, CodeDeliveryDetailsType, completionMessageType, CompromisedCredentialsActionsType, CompromisedCredentialsEventActionType(..), compromisedCredentialsEventActionType, CompromisedCredentialsRiskConfigurationType, ConfirmDeviceRequest, ConfirmDeviceResponse, ConfirmForgotPasswordRequest, ConfirmForgotPasswordResponse, ConfirmSignUpRequest, ConfirmSignUpResponse, confirmationCodeType, ContextDataType, CreateGroupRequest, CreateGroupResponse, CreateIdentityProviderRequest, CreateIdentityProviderResponse, CreateResourceServerRequest, CreateResourceServerResponse, CreateUserImportJobRequest, CreateUserImportJobResponse, CreateUserPoolClientRequest, CreateUserPoolClientResponse, CreateUserPoolDomainRequest, CreateUserPoolDomainResponse, CreateUserPoolRequest, CreateUserPoolResponse, customAttributeNameType, CustomAttributesListType, CustomDomainConfigType, DateType, DefaultEmailOptionType(..), defaultEmailOptionType, DeleteGroupRequest, DeleteIdentityProviderRequest, DeleteResourceServerRequest, DeleteUserAttributesRequest, DeleteUserAttributesResponse, DeleteUserPoolClientRequest, DeleteUserPoolDomainRequest, DeleteUserPoolDomainResponse, DeleteUserPoolRequest, DeleteUserRequest, DeliveryMediumListType, DeliveryMediumType(..), deliveryMediumType, DescribeIdentityProviderRequest, DescribeIdentityProviderResponse, DescribeResourceServerRequest, DescribeResourceServerResponse, DescribeRiskConfigurationRequest, DescribeRiskConfigurationResponse, DescribeUserImportJobRequest, DescribeUserImportJobResponse, DescribeUserPoolClientRequest, DescribeUserPoolClientResponse, DescribeUserPoolDomainRequest, DescribeUserPoolDomainResponse, DescribeUserPoolRequest, DescribeUserPoolResponse, descriptionType, DeviceConfigurationType, deviceKeyType, DeviceListType, deviceNameType, DeviceRememberedStatusType(..), deviceRememberedStatusType, DeviceSecretVerifierConfigType, DeviceType, DomainDescriptionType, DomainStatusType(..), domainStatusType, domainType, domainVersionType, emailAddressType, EmailConfigurationType, emailNotificationBodyType, emailNotificationSubjectType, EmailSendingAccountType(..), emailSendingAccountType, emailVerificationMessageByLinkType, emailVerificationMessageType, emailVerificationSubjectByLinkType, emailVerificationSubjectType, EventContextDataType, EventFeedbackType, EventFilterType(..), eventFilterType, EventFiltersType, eventIdType, EventResponseType(..), eventResponseType, EventRiskType, EventType(..), eventType, ExplicitAuthFlowsListType, ExplicitAuthFlowsType(..), explicitAuthFlowsType, FeedbackValueType(..), feedbackValueType, ForceAliasCreation, ForgetDeviceRequest, ForgotPasswordRequest, ForgotPasswordResponse, GenerateSecret, GetCsvheaderRequest, GetCsvheaderResponse, GetDeviceRequest, GetDeviceResponse, GetGroupRequest, GetGroupResponse, GetIdentityProviderByIdentifierRequest, GetIdentityProviderByIdentifierResponse, GetSigningCertificateRequest, GetSigningCertificateResponse, GetUicustomizationRequest, GetUicustomizationResponse, GetUserAttributeVerificationCodeRequest, GetUserAttributeVerificationCodeResponse, GetUserPoolMfaConfigRequest, GetUserPoolMfaConfigResponse, GetUserRequest, GetUserResponse, GlobalSignOutRequest, GlobalSignOutResponse, GroupListType, groupNameType, GroupType, hexStringType, HttpHeader, HttpHeaderList, IdentityProviderType, IdentityProviderTypeType(..), identityProviderTypeType, idpIdentifierType, IdpIdentifiersListType, ImageFileType, ImageUrlType, InitiateAuthRequest, InitiateAuthResponse, IntegerType, LambdaConfigType, ListDevicesRequest, ListDevicesResponse, ListGroupsRequest, ListGroupsResponse, ListIdentityProvidersRequest, ListIdentityProvidersResponse, ListOfStringTypes, listProvidersLimitType, listResourceServersLimitType, ListResourceServersRequest, ListResourceServersResponse, ListTagsForResourceRequest, ListTagsForResourceResponse, ListUserImportJobsRequest, ListUserImportJobsResponse, ListUserPoolClientsRequest, ListUserPoolClientsResponse, ListUserPoolsRequest, ListUserPoolsResponse, ListUsersInGroupRequest, ListUsersInGroupResponse, ListUsersRequest, ListUsersResponse, LogoutUrlsListType, LongType, MfaoptionListType, MfaoptionType, MessageActionType(..), messageActionType, MessageTemplateType, NewDeviceMetadataType, NotifyConfigurationType, NotifyEmailType, NumberAttributeConstraintsType, OauthFlowType(..), oauthFlowType, OauthFlowsType, paginationKey, paginationKeyType, passwordPolicyMinLengthType, PasswordPolicyType, passwordType, poolQueryLimitType, preSignedUrlType, precedenceType, ProviderDescription, ProviderDetailsType, providerNameType, providerNameTypeV1, ProviderUserIdentifierType, ProvidersListType, queryLimit, queryLimitType, redirectUrlType, refreshTokenValidityType, ResendConfirmationCodeRequest, ResendConfirmationCodeResponse, resourceServerIdentifierType, resourceServerNameType, resourceServerScopeDescriptionType, ResourceServerScopeListType, resourceServerScopeNameType, ResourceServerScopeType, ResourceServerType, ResourceServersListType, RespondToAuthChallengeRequest, RespondToAuthChallengeResponse, RiskConfigurationType, RiskDecisionType(..), riskDecisionType, RiskExceptionConfigurationType, RiskLevelType(..), riskLevelType, s3BucketType, SmsmfaSettingsType, SchemaAttributeType, SchemaAttributesListType, ScopeListType, scopeType, searchPaginationTokenType, SearchedAttributeNamesListType, secretCodeType, secretHashType, sessionType, SetRiskConfigurationRequest, SetRiskConfigurationResponse, SetUicustomizationRequest, SetUicustomizationResponse, SetUserMfapreferenceRequest, SetUserMfapreferenceResponse, SetUserPoolMfaConfigRequest, SetUserPoolMfaConfigResponse, SetUserSettingsRequest, SetUserSettingsResponse, SignUpRequest, SignUpResponse, SkippedIprangeListType, SmsConfigurationType, SmsMfaConfigType, smsVerificationMessageType, softwareTokenMfauserCodeType, SoftwareTokenMfaConfigType, SoftwareTokenMfaSettingsType, StartUserImportJobRequest, StartUserImportJobResponse, StatusType(..), statusType, StopUserImportJobRequest, StopUserImportJobResponse, StringAttributeConstraintsType, StringType, SupportedIdentityProvidersListType, tagKeysType, TagResourceRequest, TagResourceResponse, tagValueType, temporaryPasswordValidityDaysType, tokenModelType, UicustomizationType, UntagResourceRequest, UntagResourceResponse, UpdateAuthEventFeedbackRequest, UpdateAuthEventFeedbackResponse, UpdateDeviceStatusRequest, UpdateDeviceStatusResponse, UpdateGroupRequest, UpdateGroupResponse, UpdateIdentityProviderRequest, UpdateIdentityProviderResponse, UpdateResourceServerRequest, UpdateResourceServerResponse, UpdateUserAttributesRequest, UpdateUserAttributesResponse, UpdateUserPoolClientRequest, UpdateUserPoolClientResponse, UpdateUserPoolDomainRequest, UpdateUserPoolDomainResponse, UpdateUserPoolRequest, UpdateUserPoolResponse, UserContextDataType, userFilterType, userImportJobIdType, userImportJobNameType, UserImportJobStatusType(..), userImportJobStatusType, UserImportJobType, UserImportJobsListType, UserMfasettingListType, UserPoolAddOnsType, UserPoolClientDescription, UserPoolClientListType, UserPoolClientType, UserPoolDescriptionType, userPoolIdType, UserPoolListType, UserPoolMfaType(..), userPoolMfaType, userPoolNameType, UserPoolPolicyType, UserPoolTagsListType, UserPoolTagsType, UserPoolType, UserStatusType(..), userStatusType, UserType, UsernameAttributeType(..), usernameAttributeType, UsernameAttributesListType, usernameType, UsersListType, VerificationMessageTemplateType, VerifiedAttributeType(..), verifiedAttributeType, VerifiedAttributesListType, VerifySoftwareTokenRequest, VerifySoftwareTokenResponse, VerifySoftwareTokenResponseType(..), verifySoftwareTokenResponseType, VerifyUserAttributeRequest, VerifyUserAttributeResponse
    , verifyUserAttributeResponseCodec, verifyUserAttributeRequestCodec, verifySoftwareTokenResponseTypeCodec, verifySoftwareTokenResponseCodec, verifySoftwareTokenRequestCodec, verifiedAttributesListTypeCodec, verifiedAttributeTypeCodec, verificationMessageTemplateTypeCodec, usersListTypeCodec, usernameTypeCodec, usernameAttributesListTypeCodec, usernameAttributeTypeCodec, userTypeCodec, userStatusTypeCodec, userPoolTypeCodec, userPoolTagsTypeCodec, userPoolTagsListTypeCodec, userPoolPolicyTypeCodec, userPoolNameTypeCodec, userPoolMfaTypeCodec, userPoolListTypeCodec, userPoolIdTypeCodec, userPoolDescriptionTypeCodec, userPoolClientTypeCodec, userPoolClientListTypeCodec, userPoolClientDescriptionCodec, userPoolAddOnsTypeCodec, userMfasettingListTypeCodec, userImportJobsListTypeCodec, userImportJobTypeCodec, userImportJobStatusTypeCodec, userImportJobNameTypeCodec, userImportJobIdTypeCodec, userFilterTypeCodec, userContextDataTypeCodec, updateUserPoolResponseCodec, updateUserPoolRequestCodec, updateUserPoolDomainResponseCodec, updateUserPoolDomainRequestCodec, updateUserPoolClientResponseCodec, updateUserPoolClientRequestCodec, updateUserAttributesResponseCodec, updateUserAttributesRequestCodec, updateResourceServerResponseCodec, updateResourceServerRequestCodec, updateIdentityProviderResponseCodec, updateIdentityProviderRequestCodec, updateGroupResponseCodec, updateGroupRequestCodec, updateDeviceStatusResponseCodec, updateDeviceStatusRequestCodec, updateAuthEventFeedbackResponseCodec, updateAuthEventFeedbackRequestCodec, untagResourceResponseCodec, untagResourceRequestCodec, uicustomizationTypeCodec, tokenModelTypeCodec, temporaryPasswordValidityDaysTypeCodec, tagValueTypeCodec, tagResourceResponseCodec, tagResourceRequestCodec, tagKeysTypeCodec, supportedIdentityProvidersListTypeCodec, stringTypeCodec, stringAttributeConstraintsTypeCodec, stopUserImportJobResponseCodec, stopUserImportJobRequestCodec, statusTypeCodec, startUserImportJobResponseCodec, startUserImportJobRequestCodec, softwareTokenMfaSettingsTypeCodec, softwareTokenMfaConfigTypeCodec, softwareTokenMfauserCodeTypeCodec, smsVerificationMessageTypeCodec, smsMfaConfigTypeCodec, smsConfigurationTypeCodec, skippedIprangeListTypeCodec, signUpResponseCodec, signUpRequestCodec, setUserSettingsResponseCodec, setUserSettingsRequestCodec, setUserPoolMfaConfigResponseCodec, setUserPoolMfaConfigRequestCodec, setUserMfapreferenceResponseCodec, setUserMfapreferenceRequestCodec, setUicustomizationResponseCodec, setUicustomizationRequestCodec, setRiskConfigurationResponseCodec, setRiskConfigurationRequestCodec, sessionTypeCodec, secretHashTypeCodec, secretCodeTypeCodec, searchedAttributeNamesListTypeCodec, searchPaginationTokenTypeCodec, scopeTypeCodec, scopeListTypeCodec, schemaAttributesListTypeCodec, schemaAttributeTypeCodec, smsmfaSettingsTypeCodec, s3BucketTypeCodec, riskLevelTypeCodec, riskExceptionConfigurationTypeCodec, riskDecisionTypeCodec, riskConfigurationTypeCodec, respondToAuthChallengeResponseCodec, respondToAuthChallengeRequestCodec, resourceServersListTypeCodec, resourceServerTypeCodec, resourceServerScopeTypeCodec, resourceServerScopeNameTypeCodec, resourceServerScopeListTypeCodec, resourceServerScopeDescriptionTypeCodec, resourceServerNameTypeCodec, resourceServerIdentifierTypeCodec, resendConfirmationCodeResponseCodec, resendConfirmationCodeRequestCodec, refreshTokenValidityTypeCodec, redirectUrlTypeCodec, queryLimitTypeCodec, queryLimitCodec, providersListTypeCodec, providerUserIdentifierTypeCodec, providerNameTypeV1Codec, providerNameTypeCodec, providerDetailsTypeCodec, providerDescriptionCodec, precedenceTypeCodec, preSignedUrlTypeCodec, poolQueryLimitTypeCodec, passwordTypeCodec, passwordPolicyTypeCodec, passwordPolicyMinLengthTypeCodec, paginationKeyTypeCodec, paginationKeyCodec, oauthFlowsTypeCodec, oauthFlowTypeCodec, numberAttributeConstraintsTypeCodec, notifyEmailTypeCodec, notifyConfigurationTypeCodec, newDeviceMetadataTypeCodec, messageTemplateTypeCodec, messageActionTypeCodec, mfaoptionTypeCodec, mfaoptionListTypeCodec, longTypeCodec, logoutUrlsListTypeCodec, listUsersResponseCodec, listUsersRequestCodec, listUsersInGroupResponseCodec, listUsersInGroupRequestCodec, listUserPoolsResponseCodec, listUserPoolsRequestCodec, listUserPoolClientsResponseCodec, listUserPoolClientsRequestCodec, listUserImportJobsResponseCodec, listUserImportJobsRequestCodec, listTagsForResourceResponseCodec, listTagsForResourceRequestCodec, listResourceServersResponseCodec, listResourceServersRequestCodec, listResourceServersLimitTypeCodec, listProvidersLimitTypeCodec, listOfStringTypesCodec, listIdentityProvidersResponseCodec, listIdentityProvidersRequestCodec, listGroupsResponseCodec, listGroupsRequestCodec, listDevicesResponseCodec, listDevicesRequestCodec, lambdaConfigTypeCodec, integerTypeCodec, initiateAuthResponseCodec, initiateAuthRequestCodec, imageUrlTypeCodec, imageFileTypeCodec, idpIdentifiersListTypeCodec, idpIdentifierTypeCodec, identityProviderTypeTypeCodec, identityProviderTypeCodec, httpHeaderListCodec, httpHeaderCodec, hexStringTypeCodec, groupTypeCodec, groupNameTypeCodec, groupListTypeCodec, globalSignOutResponseCodec, globalSignOutRequestCodec, getUserResponseCodec, getUserRequestCodec, getUserPoolMfaConfigResponseCodec, getUserPoolMfaConfigRequestCodec, getUserAttributeVerificationCodeResponseCodec, getUserAttributeVerificationCodeRequestCodec, getUicustomizationResponseCodec, getUicustomizationRequestCodec, getSigningCertificateResponseCodec, getSigningCertificateRequestCodec, getIdentityProviderByIdentifierResponseCodec, getIdentityProviderByIdentifierRequestCodec, getGroupResponseCodec, getGroupRequestCodec, getDeviceResponseCodec, getDeviceRequestCodec, getCsvheaderResponseCodec, getCsvheaderRequestCodec, generateSecretCodec, forgotPasswordResponseCodec, forgotPasswordRequestCodec, forgetDeviceRequestCodec, forceAliasCreationCodec, feedbackValueTypeCodec, explicitAuthFlowsTypeCodec, explicitAuthFlowsListTypeCodec, eventTypeCodec, eventRiskTypeCodec, eventResponseTypeCodec, eventIdTypeCodec, eventFiltersTypeCodec, eventFilterTypeCodec, eventFeedbackTypeCodec, eventContextDataTypeCodec, emailVerificationSubjectTypeCodec, emailVerificationSubjectByLinkTypeCodec, emailVerificationMessageTypeCodec, emailVerificationMessageByLinkTypeCodec, emailSendingAccountTypeCodec, emailNotificationSubjectTypeCodec, emailNotificationBodyTypeCodec, emailConfigurationTypeCodec, emailAddressTypeCodec, domainVersionTypeCodec, domainTypeCodec, domainStatusTypeCodec, domainDescriptionTypeCodec, deviceTypeCodec, deviceSecretVerifierConfigTypeCodec, deviceRememberedStatusTypeCodec, deviceNameTypeCodec, deviceListTypeCodec, deviceKeyTypeCodec, deviceConfigurationTypeCodec, descriptionTypeCodec, describeUserPoolResponseCodec, describeUserPoolRequestCodec, describeUserPoolDomainResponseCodec, describeUserPoolDomainRequestCodec, describeUserPoolClientResponseCodec, describeUserPoolClientRequestCodec, describeUserImportJobResponseCodec, describeUserImportJobRequestCodec, describeRiskConfigurationResponseCodec, describeRiskConfigurationRequestCodec, describeResourceServerResponseCodec, describeResourceServerRequestCodec, describeIdentityProviderResponseCodec, describeIdentityProviderRequestCodec, deliveryMediumTypeCodec, deliveryMediumListTypeCodec, deleteUserRequestCodec, deleteUserPoolRequestCodec, deleteUserPoolDomainResponseCodec, deleteUserPoolDomainRequestCodec, deleteUserPoolClientRequestCodec, deleteUserAttributesResponseCodec, deleteUserAttributesRequestCodec, deleteResourceServerRequestCodec, deleteIdentityProviderRequestCodec, deleteGroupRequestCodec, defaultEmailOptionTypeCodec, dateTypeCodec, customDomainConfigTypeCodec, customAttributesListTypeCodec, customAttributeNameTypeCodec, createUserPoolResponseCodec, createUserPoolRequestCodec, createUserPoolDomainResponseCodec, createUserPoolDomainRequestCodec, createUserPoolClientResponseCodec, createUserPoolClientRequestCodec, createUserImportJobResponseCodec, createUserImportJobRequestCodec, createResourceServerResponseCodec, createResourceServerRequestCodec, createIdentityProviderResponseCodec, createIdentityProviderRequestCodec, createGroupResponseCodec, createGroupRequestCodec, contextDataTypeCodec, confirmationCodeTypeCodec, confirmSignUpResponseCodec, confirmSignUpRequestCodec, confirmForgotPasswordResponseCodec, confirmForgotPasswordRequestCodec, confirmDeviceResponseCodec, confirmDeviceRequestCodec, compromisedCredentialsRiskConfigurationTypeCodec, compromisedCredentialsEventActionTypeCodec, compromisedCredentialsActionsTypeCodec, completionMessageTypeCodec, codeDeliveryDetailsTypeCodec, codeDeliveryDetailsListTypeCodec, clientSecretTypeCodec, clientPermissionTypeCodec, clientPermissionListTypeCodec, clientNameTypeCodec, clientMetadataTypeCodec, clientIdTypeCodec, changePasswordResponseCodec, changePasswordRequestCodec, challengeResponsesTypeCodec, challengeResponseTypeCodec, challengeResponseListTypeCodec, challengeResponseCodec, challengeParametersTypeCodec, challengeNameTypeCodec, challengeNameCodec, callbackUrlsListTypeCodec, cssversionTypeCodec, csstypeCodec, booleanTypeCodec, blockedIprangeListTypeCodec, authenticationResultTypeCodec, authParametersTypeCodec, authFlowTypeCodec, authEventsTypeCodec, authEventTypeCodec, attributeValueTypeCodec, attributeTypeCodec, attributeNameTypeCodec, attributeNameListTypeCodec, attributeMappingTypeCodec, attributeMappingKeyTypeCodec, attributeListTypeCodec, attributeDataTypeCodec, associateSoftwareTokenResponseCodec, associateSoftwareTokenRequestCodec, arnTypeCodec, analyticsMetadataTypeCodec, analyticsConfigurationTypeCodec, aliasAttributesListTypeCodec, aliasAttributeTypeCodec, advancedSecurityModeTypeCodec, adminUserGlobalSignOutResponseCodec, adminUserGlobalSignOutRequestCodec, adminUpdateUserAttributesResponseCodec, adminUpdateUserAttributesRequestCodec, adminUpdateDeviceStatusResponseCodec, adminUpdateDeviceStatusRequestCodec, adminUpdateAuthEventFeedbackResponseCodec, adminUpdateAuthEventFeedbackRequestCodec, adminSetUserSettingsResponseCodec, adminSetUserSettingsRequestCodec, adminSetUserPasswordResponseCodec, adminSetUserPasswordRequestCodec, adminSetUserMfapreferenceResponseCodec, adminSetUserMfapreferenceRequestCodec, adminRespondToAuthChallengeResponseCodec, adminRespondToAuthChallengeRequestCodec, adminResetUserPasswordResponseCodec, adminResetUserPasswordRequestCodec, adminRemoveUserFromGroupRequestCodec, adminListUserAuthEventsResponseCodec, adminListUserAuthEventsRequestCodec, adminListGroupsForUserResponseCodec, adminListGroupsForUserRequestCodec, adminListDevicesResponseCodec, adminListDevicesRequestCodec, adminLinkProviderForUserResponseCodec, adminLinkProviderForUserRequestCodec, adminInitiateAuthResponseCodec, adminInitiateAuthRequestCodec, adminGetUserResponseCodec, adminGetUserRequestCodec, adminGetDeviceResponseCodec, adminGetDeviceRequestCodec, adminForgetDeviceRequestCodec, adminEnableUserResponseCodec, adminEnableUserRequestCodec, adminDisableUserResponseCodec, adminDisableUserRequestCodec, adminDisableProviderForUserResponseCodec, adminDisableProviderForUserRequestCodec, adminDeleteUserRequestCodec, adminDeleteUserAttributesResponseCodec, adminDeleteUserAttributesRequestCodec, adminCreateUserUnusedAccountValidityDaysTypeCodec, adminCreateUserResponseCodec, adminCreateUserRequestCodec, adminCreateUserConfigTypeCodec, adminConfirmSignUpResponseCodec, adminConfirmSignUpRequestCodec, adminAddUserToGroupRequestCodec, addCustomAttributesResponseCodec, addCustomAttributesRequestCodec, accountTakeoverRiskConfigurationTypeCodec, accountTakeoverEventActionTypeCodec, accountTakeoverActionsTypeCodec, accountTakeoverActionTypeCodec, accountTakeoverActionNotifyTypeCodec, awsaccountIdTypeCodec
    )
...
@docs addCustomAttributes, adminAddUserToGroup, adminConfirmSignUp, adminCreateUser, adminDeleteUser, adminDeleteUserAttributes, adminDisableProviderForUser, adminDisableUser, adminEnableUser, adminForgetDevice, adminGetDevice, adminGetUser, adminInitiateAuth, adminLinkProviderForUser, adminListDevices, adminListGroupsForUser, adminListUserAuthEvents, adminRemoveUserFromGroup, adminResetUserPassword, adminRespondToAuthChallenge, adminSetUserMfapreference, adminSetUserPassword, adminSetUserSettings, adminUpdateAuthEventFeedback, adminUpdateDeviceStatus, adminUpdateUserAttributes, adminUserGlobalSignOut, associateSoftwareToken, changePassword, confirmDevice, confirmForgotPassword, confirmSignUp, createGroup, createIdentityProvider, createResourceServer, createUserImportJob, createUserPool, createUserPoolClient, createUserPoolDomain, deleteGroup, deleteIdentityProvider, deleteResourceServer, deleteUser, deleteUserAttributes, deleteUserPool, deleteUserPoolClient, deleteUserPoolDomain, describeIdentityProvider, describeResourceServer, describeRiskConfiguration, describeUserImportJob, describeUserPool, describeUserPoolClient, describeUserPoolDomain, forgetDevice, forgotPassword, getCsvheader, getDevice, getGroup, getIdentityProviderByIdentifier, getSigningCertificate, getUicustomization, getUser, getUserAttributeVerificationCode, getUserPoolMfaConfig, globalSignOut, initiateAuth, listDevices, listGroups, listIdentityProviders, listResourceServers, listTagsForResource, listUserImportJobs, listUserPoolClients, listUserPools, listUsers, listUsersInGroup, resendConfirmationCode, respondToAuthChallenge, setRiskConfiguration, setUicustomization, setUserMfapreference, setUserPoolMfaConfig, setUserSettings, signUp, startUserImportJob, stopUserImportJob, tagResource, untagResource, updateAuthEventFeedback, updateDeviceStatus, updateGroup, updateIdentityProvider, updateResourceServer, updateUserAttributes, updateUserPool, updateUserPoolClient, updateUserPoolDomain, verifySoftwareToken, verifyUserAttribute


# API data model.

@docs AwsaccountIdType, AccountTakeoverActionNotifyType, AccountTakeoverActionType, AccountTakeoverActionsType, AccountTakeoverEventActionType, accountTakeoverEventActionType, AccountTakeoverRiskConfigurationType, AddCustomAttributesRequest, AddCustomAttributesResponse, AdminAddUserToGroupRequest, AdminConfirmSignUpRequest, AdminConfirmSignUpResponse, AdminCreateUserConfigType, AdminCreateUserRequest, AdminCreateUserResponse, adminCreateUserUnusedAccountValidityDaysType, AdminDeleteUserAttributesRequest, AdminDeleteUserAttributesResponse, AdminDeleteUserRequest, AdminDisableProviderForUserRequest, AdminDisableProviderForUserResponse, AdminDisableUserRequest, AdminDisableUserResponse, AdminEnableUserRequest, AdminEnableUserResponse, AdminForgetDeviceRequest, AdminGetDeviceRequest, AdminGetDeviceResponse, AdminGetUserRequest, AdminGetUserResponse, AdminInitiateAuthRequest, AdminInitiateAuthResponse, AdminLinkProviderForUserRequest, AdminLinkProviderForUserResponse, AdminListDevicesRequest, AdminListDevicesResponse, AdminListGroupsForUserRequest, AdminListGroupsForUserResponse, AdminListUserAuthEventsRequest, AdminListUserAuthEventsResponse, AdminRemoveUserFromGroupRequest, AdminResetUserPasswordRequest, AdminResetUserPasswordResponse, AdminRespondToAuthChallengeRequest, AdminRespondToAuthChallengeResponse, AdminSetUserMfapreferenceRequest, AdminSetUserMfapreferenceResponse, AdminSetUserPasswordRequest, AdminSetUserPasswordResponse, AdminSetUserSettingsRequest, AdminSetUserSettingsResponse, AdminUpdateAuthEventFeedbackRequest, AdminUpdateAuthEventFeedbackResponse, AdminUpdateDeviceStatusRequest, AdminUpdateDeviceStatusResponse, AdminUpdateUserAttributesRequest, AdminUpdateUserAttributesResponse, AdminUserGlobalSignOutRequest, AdminUserGlobalSignOutResponse, AdvancedSecurityModeType, advancedSecurityModeType, AliasAttributeType, aliasAttributeType, AliasAttributesListType, AnalyticsConfigurationType, AnalyticsMetadataType, arnType, AssociateSoftwareTokenRequest, AssociateSoftwareTokenResponse, AttributeDataType, attributeDataType, AttributeListType, attributeMappingKeyType, AttributeMappingType, AttributeNameListType, attributeNameType, AttributeType, attributeValueType, AuthEventType, AuthEventsType, AuthFlowType, authFlowType, AuthParametersType, AuthenticationResultType, BlockedIprangeListType, BooleanType, Csstype, CssversionType, CallbackUrlsListType, ChallengeName, challengeName, ChallengeNameType, challengeNameType, ChallengeParametersType, ChallengeResponse, challengeResponse, ChallengeResponseListType, ChallengeResponseType, ChallengeResponsesType, ChangePasswordRequest, ChangePasswordResponse, clientIdType, ClientMetadataType, clientNameType, ClientPermissionListType, clientPermissionType, clientSecretType, CodeDeliveryDetailsListType, CodeDeliveryDetailsType, completionMessageType, CompromisedCredentialsActionsType, CompromisedCredentialsEventActionType, compromisedCredentialsEventActionType, CompromisedCredentialsRiskConfigurationType, ConfirmDeviceRequest, ConfirmDeviceResponse, ConfirmForgotPasswordRequest, ConfirmForgotPasswordResponse, ConfirmSignUpRequest, ConfirmSignUpResponse, confirmationCodeType, ContextDataType, CreateGroupRequest, CreateGroupResponse, CreateIdentityProviderRequest, CreateIdentityProviderResponse, CreateResourceServerRequest, CreateResourceServerResponse, CreateUserImportJobRequest, CreateUserImportJobResponse, CreateUserPoolClientRequest, CreateUserPoolClientResponse, CreateUserPoolDomainRequest, CreateUserPoolDomainResponse, CreateUserPoolRequest, CreateUserPoolResponse, customAttributeNameType, CustomAttributesListType, CustomDomainConfigType, DateType, DefaultEmailOptionType, defaultEmailOptionType, DeleteGroupRequest, DeleteIdentityProviderRequest, DeleteResourceServerRequest, DeleteUserAttributesRequest, DeleteUserAttributesResponse, DeleteUserPoolClientRequest, DeleteUserPoolDomainRequest, DeleteUserPoolDomainResponse, DeleteUserPoolRequest, DeleteUserRequest, DeliveryMediumListType, DeliveryMediumType, deliveryMediumType, DescribeIdentityProviderRequest, DescribeIdentityProviderResponse, DescribeResourceServerRequest, DescribeResourceServerResponse, DescribeRiskConfigurationRequest, DescribeRiskConfigurationResponse, DescribeUserImportJobRequest, DescribeUserImportJobResponse, DescribeUserPoolClientRequest, DescribeUserPoolClientResponse, DescribeUserPoolDomainRequest, DescribeUserPoolDomainResponse, DescribeUserPoolRequest, DescribeUserPoolResponse, descriptionType, DeviceConfigurationType, deviceKeyType, DeviceListType, deviceNameType, DeviceRememberedStatusType, deviceRememberedStatusType, DeviceSecretVerifierConfigType, DeviceType, DomainDescriptionType, DomainStatusType, domainStatusType, domainType, domainVersionType, emailAddressType, EmailConfigurationType, emailNotificationBodyType, emailNotificationSubjectType, EmailSendingAccountType, emailSendingAccountType, emailVerificationMessageByLinkType, emailVerificationMessageType, emailVerificationSubjectByLinkType, emailVerificationSubjectType, EventContextDataType, EventFeedbackType, EventFilterType, eventFilterType, EventFiltersType, eventIdType, EventResponseType, eventResponseType, EventRiskType, EventType, eventType, ExplicitAuthFlowsListType, ExplicitAuthFlowsType, explicitAuthFlowsType, FeedbackValueType, feedbackValueType, ForceAliasCreation, ForgetDeviceRequest, ForgotPasswordRequest, ForgotPasswordResponse, GenerateSecret, GetCsvheaderRequest, GetCsvheaderResponse, GetDeviceRequest, GetDeviceResponse, GetGroupRequest, GetGroupResponse, GetIdentityProviderByIdentifierRequest, GetIdentityProviderByIdentifierResponse, GetSigningCertificateRequest, GetSigningCertificateResponse, GetUicustomizationRequest, GetUicustomizationResponse, GetUserAttributeVerificationCodeRequest, GetUserAttributeVerificationCodeResponse, GetUserPoolMfaConfigRequest, GetUserPoolMfaConfigResponse, GetUserRequest, GetUserResponse, GlobalSignOutRequest, GlobalSignOutResponse, GroupListType, groupNameType, GroupType, hexStringType, HttpHeader, HttpHeaderList, IdentityProviderType, IdentityProviderTypeType, identityProviderTypeType, idpIdentifierType, IdpIdentifiersListType, ImageFileType, ImageUrlType, InitiateAuthRequest, InitiateAuthResponse, IntegerType, LambdaConfigType, ListDevicesRequest, ListDevicesResponse, ListGroupsRequest, ListGroupsResponse, ListIdentityProvidersRequest, ListIdentityProvidersResponse, ListOfStringTypes, listProvidersLimitType, listResourceServersLimitType, ListResourceServersRequest, ListResourceServersResponse, ListTagsForResourceRequest, ListTagsForResourceResponse, ListUserImportJobsRequest, ListUserImportJobsResponse, ListUserPoolClientsRequest, ListUserPoolClientsResponse, ListUserPoolsRequest, ListUserPoolsResponse, ListUsersInGroupRequest, ListUsersInGroupResponse, ListUsersRequest, ListUsersResponse, LogoutUrlsListType, LongType, MfaoptionListType, MfaoptionType, MessageActionType, messageActionType, MessageTemplateType, NewDeviceMetadataType, NotifyConfigurationType, NotifyEmailType, NumberAttributeConstraintsType, OauthFlowType, oauthFlowType, OauthFlowsType, paginationKey, paginationKeyType, passwordPolicyMinLengthType, PasswordPolicyType, passwordType, poolQueryLimitType, preSignedUrlType, precedenceType, ProviderDescription, ProviderDetailsType, providerNameType, providerNameTypeV1, ProviderUserIdentifierType, ProvidersListType, queryLimit, queryLimitType, redirectUrlType, refreshTokenValidityType, ResendConfirmationCodeRequest, ResendConfirmationCodeResponse, resourceServerIdentifierType, resourceServerNameType, resourceServerScopeDescriptionType, ResourceServerScopeListType, resourceServerScopeNameType, ResourceServerScopeType, ResourceServerType, ResourceServersListType, RespondToAuthChallengeRequest, RespondToAuthChallengeResponse, RiskConfigurationType, RiskDecisionType, riskDecisionType, RiskExceptionConfigurationType, RiskLevelType, riskLevelType, s3BucketType, SmsmfaSettingsType, SchemaAttributeType, SchemaAttributesListType, ScopeListType, scopeType, searchPaginationTokenType, SearchedAttributeNamesListType, secretCodeType, secretHashType, sessionType, SetRiskConfigurationRequest, SetRiskConfigurationResponse, SetUicustomizationRequest, SetUicustomizationResponse, SetUserMfapreferenceRequest, SetUserMfapreferenceResponse, SetUserPoolMfaConfigRequest, SetUserPoolMfaConfigResponse, SetUserSettingsRequest, SetUserSettingsResponse, SignUpRequest, SignUpResponse, SkippedIprangeListType, SmsConfigurationType, SmsMfaConfigType, smsVerificationMessageType, softwareTokenMfauserCodeType, SoftwareTokenMfaConfigType, SoftwareTokenMfaSettingsType, StartUserImportJobRequest, StartUserImportJobResponse, StatusType, statusType, StopUserImportJobRequest, StopUserImportJobResponse, StringAttributeConstraintsType, StringType, SupportedIdentityProvidersListType, tagKeysType, TagResourceRequest, TagResourceResponse, tagValueType, temporaryPasswordValidityDaysType, tokenModelType, UicustomizationType, UntagResourceRequest, UntagResourceResponse, UpdateAuthEventFeedbackRequest, UpdateAuthEventFeedbackResponse, UpdateDeviceStatusRequest, UpdateDeviceStatusResponse, UpdateGroupRequest, UpdateGroupResponse, UpdateIdentityProviderRequest, UpdateIdentityProviderResponse, UpdateResourceServerRequest, UpdateResourceServerResponse, UpdateUserAttributesRequest, UpdateUserAttributesResponse, UpdateUserPoolClientRequest, UpdateUserPoolClientResponse, UpdateUserPoolDomainRequest, UpdateUserPoolDomainResponse, UpdateUserPoolRequest, UpdateUserPoolResponse, UserContextDataType, userFilterType, userImportJobIdType, userImportJobNameType, UserImportJobStatusType, userImportJobStatusType, UserImportJobType, UserImportJobsListType, UserMfasettingListType, UserPoolAddOnsType, UserPoolClientDescription, UserPoolClientListType, UserPoolClientType, UserPoolDescriptionType, userPoolIdType, UserPoolListType, UserPoolMfaType, userPoolMfaType, userPoolNameType, UserPoolPolicyType, UserPoolTagsListType, UserPoolTagsType, UserPoolType, UserStatusType, userStatusType, UserType, UsernameAttributeType, usernameAttributeType, UsernameAttributesListType, usernameType, UsersListType, VerificationMessageTemplateType, VerifiedAttributeType, verifiedAttributeType, VerifiedAttributesListType, VerifySoftwareTokenRequest, VerifySoftwareTokenResponse, VerifySoftwareTokenResponseType, verifySoftwareTokenResponseType, VerifyUserAttributeRequest, VerifyUserAttributeResponse


# Codecs for the data model.

@docs verifyUserAttributeResponseCodec, verifyUserAttributeRequestCodec, verifySoftwareTokenResponseTypeCodec, verifySoftwareTokenResponseCodec, verifySoftwareTokenRequestCodec, verifiedAttributesListTypeCodec, verifiedAttributeTypeCodec, verificationMessageTemplateTypeCodec, usersListTypeCodec, usernameTypeCodec, usernameAttributesListTypeCodec, usernameAttributeTypeCodec, userTypeCodec, userStatusTypeCodec, userPoolTypeCodec, userPoolTagsTypeCodec, userPoolTagsListTypeCodec, userPoolPolicyTypeCodec, userPoolNameTypeCodec, userPoolMfaTypeCodec, userPoolListTypeCodec, userPoolIdTypeCodec, userPoolDescriptionTypeCodec, userPoolClientTypeCodec, userPoolClientListTypeCodec, userPoolClientDescriptionCodec, userPoolAddOnsTypeCodec, userMfasettingListTypeCodec, userImportJobsListTypeCodec, userImportJobTypeCodec, userImportJobStatusTypeCodec, userImportJobNameTypeCodec, userImportJobIdTypeCodec, userFilterTypeCodec, userContextDataTypeCodec, updateUserPoolResponseCodec, updateUserPoolRequestCodec, updateUserPoolDomainResponseCodec, updateUserPoolDomainRequestCodec, updateUserPoolClientResponseCodec, updateUserPoolClientRequestCodec, updateUserAttributesResponseCodec, updateUserAttributesRequestCodec, updateResourceServerResponseCodec, updateResourceServerRequestCodec, updateIdentityProviderResponseCodec, updateIdentityProviderRequestCodec, updateGroupResponseCodec, updateGroupRequestCodec, updateDeviceStatusResponseCodec, updateDeviceStatusRequestCodec, updateAuthEventFeedbackResponseCodec, updateAuthEventFeedbackRequestCodec, untagResourceResponseCodec, untagResourceRequestCodec, uicustomizationTypeCodec, tokenModelTypeCodec, temporaryPasswordValidityDaysTypeCodec, tagValueTypeCodec, tagResourceResponseCodec, tagResourceRequestCodec, tagKeysTypeCodec, supportedIdentityProvidersListTypeCodec, stringTypeCodec, stringAttributeConstraintsTypeCodec, stopUserImportJobResponseCodec, stopUserImportJobRequestCodec, statusTypeCodec, startUserImportJobResponseCodec, startUserImportJobRequestCodec, softwareTokenMfaSettingsTypeCodec, softwareTokenMfaConfigTypeCodec, softwareTokenMfauserCodeTypeCodec, smsVerificationMessageTypeCodec, smsMfaConfigTypeCodec, smsConfigurationTypeCodec, skippedIprangeListTypeCodec, signUpResponseCodec, signUpRequestCodec, setUserSettingsResponseCodec, setUserSettingsRequestCodec, setUserPoolMfaConfigResponseCodec, setUserPoolMfaConfigRequestCodec, setUserMfapreferenceResponseCodec, setUserMfapreferenceRequestCodec, setUicustomizationResponseCodec, setUicustomizationRequestCodec, setRiskConfigurationResponseCodec, setRiskConfigurationRequestCodec, sessionTypeCodec, secretHashTypeCodec, secretCodeTypeCodec, searchedAttributeNamesListTypeCodec, searchPaginationTokenTypeCodec, scopeTypeCodec, scopeListTypeCodec, schemaAttributesListTypeCodec, schemaAttributeTypeCodec, smsmfaSettingsTypeCodec, s3BucketTypeCodec, riskLevelTypeCodec, riskExceptionConfigurationTypeCodec, riskDecisionTypeCodec, riskConfigurationTypeCodec, respondToAuthChallengeResponseCodec, respondToAuthChallengeRequestCodec, resourceServersListTypeCodec, resourceServerTypeCodec, resourceServerScopeTypeCodec, resourceServerScopeNameTypeCodec, resourceServerScopeListTypeCodec, resourceServerScopeDescriptionTypeCodec, resourceServerNameTypeCodec, resourceServerIdentifierTypeCodec, resendConfirmationCodeResponseCodec, resendConfirmationCodeRequestCodec, refreshTokenValidityTypeCodec, redirectUrlTypeCodec, queryLimitTypeCodec, queryLimitCodec, providersListTypeCodec, providerUserIdentifierTypeCodec, providerNameTypeV1Codec, providerNameTypeCodec, providerDetailsTypeCodec, providerDescriptionCodec, precedenceTypeCodec, preSignedUrlTypeCodec, poolQueryLimitTypeCodec, passwordTypeCodec, passwordPolicyTypeCodec, passwordPolicyMinLengthTypeCodec, paginationKeyTypeCodec, paginationKeyCodec, oauthFlowsTypeCodec, oauthFlowTypeCodec, numberAttributeConstraintsTypeCodec, notifyEmailTypeCodec, notifyConfigurationTypeCodec, newDeviceMetadataTypeCodec, messageTemplateTypeCodec, messageActionTypeCodec, mfaoptionTypeCodec, mfaoptionListTypeCodec, longTypeCodec, logoutUrlsListTypeCodec, listUsersResponseCodec, listUsersRequestCodec, listUsersInGroupResponseCodec, listUsersInGroupRequestCodec, listUserPoolsResponseCodec, listUserPoolsRequestCodec, listUserPoolClientsResponseCodec, listUserPoolClientsRequestCodec, listUserImportJobsResponseCodec, listUserImportJobsRequestCodec, listTagsForResourceResponseCodec, listTagsForResourceRequestCodec, listResourceServersResponseCodec, listResourceServersRequestCodec, listResourceServersLimitTypeCodec, listProvidersLimitTypeCodec, listOfStringTypesCodec, listIdentityProvidersResponseCodec, listIdentityProvidersRequestCodec, listGroupsResponseCodec, listGroupsRequestCodec, listDevicesResponseCodec, listDevicesRequestCodec, lambdaConfigTypeCodec, integerTypeCodec, initiateAuthResponseCodec, initiateAuthRequestCodec, imageUrlTypeCodec, imageFileTypeCodec, idpIdentifiersListTypeCodec, idpIdentifierTypeCodec, identityProviderTypeTypeCodec, identityProviderTypeCodec, httpHeaderListCodec, httpHeaderCodec, hexStringTypeCodec, groupTypeCodec, groupNameTypeCodec, groupListTypeCodec, globalSignOutResponseCodec, globalSignOutRequestCodec, getUserResponseCodec, getUserRequestCodec, getUserPoolMfaConfigResponseCodec, getUserPoolMfaConfigRequestCodec, getUserAttributeVerificationCodeResponseCodec, getUserAttributeVerificationCodeRequestCodec, getUicustomizationResponseCodec, getUicustomizationRequestCodec, getSigningCertificateResponseCodec, getSigningCertificateRequestCodec, getIdentityProviderByIdentifierResponseCodec, getIdentityProviderByIdentifierRequestCodec, getGroupResponseCodec, getGroupRequestCodec, getDeviceResponseCodec, getDeviceRequestCodec, getCsvheaderResponseCodec, getCsvheaderRequestCodec, generateSecretCodec, forgotPasswordResponseCodec, forgotPasswordRequestCodec, forgetDeviceRequestCodec, forceAliasCreationCodec, feedbackValueTypeCodec, explicitAuthFlowsTypeCodec, explicitAuthFlowsListTypeCodec, eventTypeCodec, eventRiskTypeCodec, eventResponseTypeCodec, eventIdTypeCodec, eventFiltersTypeCodec, eventFilterTypeCodec, eventFeedbackTypeCodec, eventContextDataTypeCodec, emailVerificationSubjectTypeCodec, emailVerificationSubjectByLinkTypeCodec, emailVerificationMessageTypeCodec, emailVerificationMessageByLinkTypeCodec, emailSendingAccountTypeCodec, emailNotificationSubjectTypeCodec, emailNotificationBodyTypeCodec, emailConfigurationTypeCodec, emailAddressTypeCodec, domainVersionTypeCodec, domainTypeCodec, domainStatusTypeCodec, domainDescriptionTypeCodec, deviceTypeCodec, deviceSecretVerifierConfigTypeCodec, deviceRememberedStatusTypeCodec, deviceNameTypeCodec, deviceListTypeCodec, deviceKeyTypeCodec, deviceConfigurationTypeCodec, descriptionTypeCodec, describeUserPoolResponseCodec, describeUserPoolRequestCodec, describeUserPoolDomainResponseCodec, describeUserPoolDomainRequestCodec, describeUserPoolClientResponseCodec, describeUserPoolClientRequestCodec, describeUserImportJobResponseCodec, describeUserImportJobRequestCodec, describeRiskConfigurationResponseCodec, describeRiskConfigurationRequestCodec, describeResourceServerResponseCodec, describeResourceServerRequestCodec, describeIdentityProviderResponseCodec, describeIdentityProviderRequestCodec, deliveryMediumTypeCodec, deliveryMediumListTypeCodec, deleteUserRequestCodec, deleteUserPoolRequestCodec, deleteUserPoolDomainResponseCodec, deleteUserPoolDomainRequestCodec, deleteUserPoolClientRequestCodec, deleteUserAttributesResponseCodec, deleteUserAttributesRequestCodec, deleteResourceServerRequestCodec, deleteIdentityProviderRequestCodec, deleteGroupRequestCodec, defaultEmailOptionTypeCodec, dateTypeCodec, customDomainConfigTypeCodec, customAttributesListTypeCodec, customAttributeNameTypeCodec, createUserPoolResponseCodec, createUserPoolRequestCodec, createUserPoolDomainResponseCodec, createUserPoolDomainRequestCodec, createUserPoolClientResponseCodec, createUserPoolClientRequestCodec, createUserImportJobResponseCodec, createUserImportJobRequestCodec, createResourceServerResponseCodec, createResourceServerRequestCodec, createIdentityProviderResponseCodec, createIdentityProviderRequestCodec, createGroupResponseCodec, createGroupRequestCodec, contextDataTypeCodec, confirmationCodeTypeCodec, confirmSignUpResponseCodec, confirmSignUpRequestCodec, confirmForgotPasswordResponseCodec, confirmForgotPasswordRequestCodec, confirmDeviceResponseCodec, confirmDeviceRequestCodec, compromisedCredentialsRiskConfigurationTypeCodec, compromisedCredentialsEventActionTypeCodec, compromisedCredentialsActionsTypeCodec, completionMessageTypeCodec, codeDeliveryDetailsTypeCodec, codeDeliveryDetailsListTypeCodec, clientSecretTypeCodec, clientPermissionTypeCodec, clientPermissionListTypeCodec, clientNameTypeCodec, clientMetadataTypeCodec, clientIdTypeCodec, changePasswordResponseCodec, changePasswordRequestCodec, challengeResponsesTypeCodec, challengeResponseTypeCodec, challengeResponseListTypeCodec, challengeResponseCodec, challengeParametersTypeCodec, challengeNameTypeCodec, challengeNameCodec, callbackUrlsListTypeCodec, cssversionTypeCodec, csstypeCodec, booleanTypeCodec, blockedIprangeListTypeCodec, authenticationResultTypeCodec, authParametersTypeCodec, authFlowTypeCodec, authEventsTypeCodec, authEventTypeCodec, attributeValueTypeCodec, attributeTypeCodec, attributeNameTypeCodec, attributeNameListTypeCodec, attributeMappingTypeCodec, attributeMappingKeyTypeCodec, attributeListTypeCodec, attributeDataTypeCodec, associateSoftwareTokenResponseCodec, associateSoftwareTokenRequestCodec, arnTypeCodec, analyticsMetadataTypeCodec, analyticsConfigurationTypeCodec, aliasAttributesListTypeCodec, aliasAttributeTypeCodec, advancedSecurityModeTypeCodec, adminUserGlobalSignOutResponseCodec, adminUserGlobalSignOutRequestCodec, adminUpdateUserAttributesResponseCodec, adminUpdateUserAttributesRequestCodec, adminUpdateDeviceStatusResponseCodec, adminUpdateDeviceStatusRequestCodec, adminUpdateAuthEventFeedbackResponseCodec, adminUpdateAuthEventFeedbackRequestCodec, adminSetUserSettingsResponseCodec, adminSetUserSettingsRequestCodec, adminSetUserPasswordResponseCodec, adminSetUserPasswordRequestCodec, adminSetUserMfapreferenceResponseCodec, adminSetUserMfapreferenceRequestCodec, adminRespondToAuthChallengeResponseCodec, adminRespondToAuthChallengeRequestCodec, adminResetUserPasswordResponseCodec, adminResetUserPasswordRequestCodec, adminRemoveUserFromGroupRequestCodec, adminListUserAuthEventsResponseCodec, adminListUserAuthEventsRequestCodec, adminListGroupsForUserResponseCodec, adminListGroupsForUserRequestCodec, adminListDevicesResponseCodec, adminListDevicesRequestCodec, adminLinkProviderForUserResponseCodec, adminLinkProviderForUserRequestCodec, adminInitiateAuthResponseCodec, adminInitiateAuthRequestCodec, adminGetUserResponseCodec, adminGetUserRequestCodec, adminGetDeviceResponseCodec, adminGetDeviceRequestCodec, adminForgetDeviceRequestCodec, adminEnableUserResponseCodec, adminEnableUserRequestCodec, adminDisableUserResponseCodec, adminDisableUserRequestCodec, adminDisableProviderForUserResponseCodec, adminDisableProviderForUserRequestCodec, adminDeleteUserRequestCodec, adminDeleteUserAttributesResponseCodec, adminDeleteUserAttributesRequestCodec, adminCreateUserUnusedAccountValidityDaysTypeCodec, adminCreateUserResponseCodec, adminCreateUserRequestCodec, adminCreateUserConfigTypeCodec, adminConfirmSignUpResponseCodec, adminConfirmSignUpRequestCodec, adminAddUserToGroupRequestCodec, addCustomAttributesResponseCodec, addCustomAttributesRequestCodec, accountTakeoverRiskConfigurationTypeCodec, accountTakeoverEventActionTypeCodec, accountTakeoverActionsTypeCodec, accountTakeoverActionTypeCodec, accountTakeoverActionNotifyTypeCodec, awsaccountIdTypeCodec
